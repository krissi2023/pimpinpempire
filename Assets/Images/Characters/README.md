...
This folder contains character artwork and portraits for the main characters in Pimpins Empire.
...
- **Sizes:** 512x512 (profile), 256x256 (small), 1024x1024 (detailed)
...
- **Format:** PNG with transparency
- **Sizes:** 64x64 (emoji), 128x128 (large emoji), 256x256 (profile)
- **Usage:** Chat reactions, quick character reference, social features
...
- Rich color palette matching the empire theme
